...
**Cover letter.** The letter answers the ad's most important requirements with the candidate's strongest evidenced achievements — around three, as many as the record genuinely answers and the argument has room for, never a quota. No claim in the letter that is absent from the CV.
