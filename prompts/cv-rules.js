...
- **Open on a fact (Layer 3).** The first sentence states something this candidate did, built or ran that this role needs. It is the sentence with the least competition for attention in either document. BANNED as an opening: any description of the act of applying ("I am writing to apply", "I am excited to submit"); any identity claim standing in for evidence ("As a seasoned leader", "As an accomplished professional") — the epithet ban binds the letter exactly as it binds the CV; and any ANECDOTE or scene-setting reminiscence ("I remember one of my first projects...", "Vzpomínám si na...", "It was 2019 when...", "Early in my career I learned that..."). A remembered scene reads as an after-dinner speech, spends the letter's strongest sentence on throat-clearing, and needs colour the master does not record. Name the thing done, where it was done, and what came of it.
