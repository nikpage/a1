...
- **Recency window:** full detail for the last 10-15 years. Older roles collapse into one undated "Earlier Career" line — titles and employers only, no bullets.
...
- **Impact zone — the first ~120 words of the document.** Counted by words from the top of the CV, not by rendered lines. It must carry, in this order: the target-facing HEADLINE, a 2-3 sentence VALUE PROPOSITION, and the THREE strongest evidenced achievements. The headline and value proposition are the Summary's opening prose; the three achievements are three bullets immediately beneath, inside the Summary block. Each of the three MUST name the role it comes from (e.g. "As Head of Delivery at Acme, cut release cycle from 6 weeks to 9 days") so it never reads as a floating claim. They MAY restate a Work Experience bullet — that duplication is intentional.
