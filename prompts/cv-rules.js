...
- **Impact zone — the first ~120 words of the document.** Counted by words from the top of the CV, not by rendered lines. It carries, in this order: the target-facing HEADLINE and a 2-4 sentence VALUE PROPOSITION. Both are prose. **The Summary contains NO bullets** — a bulleted summary is not a CV convention, and repeating achievements there that appear again under their roles makes the top of the document read twice. The strongest achievements earn their place under the role that produced them, where a reader can see the context.
