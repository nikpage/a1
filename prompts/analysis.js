...
- generation_framework.target_cover_words: target word COUNT (a number) for the cover letter body — 150-250, default 200, for EVERY market. Tune within that band by scenario and seniority only; there is no longer a market that carries a longer letter. It is a ceiling to cut against, never a quota: a letter that finishes its argument at 160 words is finished.
