...
- generation_framework.cv_blueprint.skills_to_highlight: 8-12 specific skills drawn ONLY from transferable_skills and ats_keywords_present (skills the candidate genuinely has), ordered by relevance to this ad. **The employer's own core domain leads the list wherever the record proves it.** A recruiter scanning a skills list reads the top few; a proven skill in the employer's own field sitting sixth has been buried. Order by what THIS employer is, not by what the candidate does most of. NEVER pull from ats_keywords_missing — a skill the record cannot prove must never appear here.
