...
4. BORROWED REQUIREMENT: a skill, tool, system or experience phrased to suggest the candidate has it when the master record shows no evidence — typically lifted from the job ad to cover a gap. The loud form is easy: "extensive Kubernetes experience" with nothing about Kubernetes in the master. **The form that gets missed is the QUIET one — the tool named in passing, as routine habit**: "I use them to evaluate data in the CRM", "day to day I work in Jira", "part of my normal workflow". A tool the master never mentions is unsupported however casually it is dropped in, and casual phrasing makes the claim MORE credible to a reader, not less. Name any tool, system or platform the document uses that the master does not.
