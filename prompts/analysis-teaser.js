...
- analysis.scan_snags: ARRAY of UP TO 3 ordered { "point": "", "detail": "" } shown ONLY when scan_verdict is "fail" — they walk through what the recruiter's eye actually hits at the TOP of THIS CV. "point" = the raw fact quoted VERBATIM from the CV with NO framing words — write the real title / date-range / tenure itself (e.g. "Salsita Software | Nov 2022 – Oct 2023"), never "Eye lands on…"; "detail" = the single one-line problem that fact creates (e.g. "An 11-month tenure that ended over a year ago"). Do NOT phrase any "detail" as a question — the open question belongs ONLY in hr_first_seconds. NEVER invent a snag to reach three; return only as many as the top-line genuinely warrants, down to one. [] whenever scan_verdict is "pass".
