...
NO REPETITION (hard rule — the teaser reads as ONE page, and a reader who sees the same point three times feels handled, not understood): red_flags and nuance_clarifications must cover DIFFERENT ground. A specific issue (a date overlap, a short tenure, duties-not-outcomes, an age signal) belongs in exactly ONE of them — the place it lands hardest — and must NOT be restated, reworded, or alluded to in the other. overall_commentary may name at most ONE tension; do not let it repeat a red_flag verbatim. Before you finish, scan your own output and delete any second mention of the same underlying fact.
