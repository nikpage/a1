...
// -----------------------------------------------------------------------------
// Helper function to apply tone to text
...
// -----------------------------------------------------------------------------
// Career Scenario Detection (untouched from your original file)
...
//==========================================================================
// CV Writer Prompt - final version with clean, correct logic
//==========================================================================
export function buildCVPrompt(originalCv, jobDetails, tone, metadata, feedbackData = null, professionalSummary = '', coreSkills = []) {
  console.log("RECEIVED professionalSummary:", professionalSummary);
  console.log("RECEIVED coreSkills:", coreSkills);
...
`;
  ...
  // Use the provided Professional Summary and Core Skills exactly as given with stronger language
  if (professionalSummary) {
    promptBase += `\n\nIMPORTANT: DO NOT MODIFY OR REWRITE THE PROFESSIONAL SUMMARY.
USE EXACTLY AS PROVIDED:\n${professionalSummary}`;
  }

  if (Array.isArray(coreSkills) && coreSkills.length > 0) {
    promptBase += `\n\nIMPORTANT: DO NOT MODIFY OR REWRITE THESE CORE SKILLS.
USE EXACTLY AS PROVIDED:\n${coreSkills.join(', ')}`;
  }
